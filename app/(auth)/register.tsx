        ...
        >
          <Surface style={styles.formContainer} elevation={4}>
            <View style={styles.logoContainer}>
              ...
              <Text style={styles.subtitle}>قم بإدخال بياناتك للتسجيل</Text>
            </View>
            ...
            {success && (
              <View style={styles.successContainer}>
                ...
                <Text style={styles.successText}>
                  تم إنشاء حسابك بنجاح! تم إرسال رسالة تأكيد إلى بريدك الإلكتروني.
            ...
            <View style={styles.inputContainer}>
              <MaterialCommunityIcons name="account" size={24} color={theme.colors.primary} style={styles.inputIcon} />
              <TextInput
                label="اسم المستخدم"
                value={username}
            ...
            <View style={styles.inputContainer}>
              <MaterialCommunityIcons name="shield-check-outline" size={24} color={theme.colors.primary} style={styles.inputIcon} />
              <TextInput
